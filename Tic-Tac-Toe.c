#include <stdio.h>
#include <conio.h>
/* Counting row,column and digonal for example
1 2 3  -> sum of row is 6
4 5 6
7 8 9 -> sum of row is 24
*/
...
void turn_counter() // this function ensure altarnate turn of X and O
{
